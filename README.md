...
LayerTechnologyBackendFastAPI, PythonFrontendJavaScript, HTML, CSSSpeech-to-TextOpenAI-compatible STT APIText-to-SpeechCartesiaLLMOpenRouter (nvidia/nemotron)DatabaseSupabasePhone callsTwilioVector storeChromaDB, HuggingFace EmbeddingsNewsNewsAPIPrayer timesaladhan-api
